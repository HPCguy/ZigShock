...
fn ComputeFaceInfo(numFace: Iter_t,
                   mass: []const Real_t,
                   momentum: []const Real_t, energy: []const Real_t, 
...
fn UpdateElemInfo(numElem: Iter_t,
                  ...
                  pressure: []Real_t, f0: []const Real_t, f1: []const Real_t,
                  f2: []const Real_t, dtdx: Real_t) void
{
   var idx: Iter_t = 1;
   while ( idx < numElem ) : ( idx += 1 ) {
...
pub fn main() !void
{
   ...
   var momentum: [numElems+1]Real_t = undefined;
   var energy: [numElems+1]Real_t   = undefined;
   var pressure: [numElems+1]Real_t = undefined;

   var f0: [numElems-1]Real_t = undefined;
   var f1: [numElems-1]Real_t = undefined;
   var f2: [numElems-1]Real_t = undefined;
